...
set(gca,'XTickLabel',h,'fontsize',14)
title('Hyperplane in 2D')
legend('Legitimate class','Malicious class','support vector (Legitimate)','support vector (Malicious)','Decision Boundry','Location','southeast')
hold off
% Dual Value
%
Ker=X*X';
